...
## GET POSITION ON QUEUE
    ...
    ## AMOUNT /// TIMESTAMPS
        execute store result score #schedule.amount l.core.temp_condition store result score #schedule.first.pos l.core.temp_condition if data storage leinad_perm:schedule generic.queue[]
    ...
    ## INSERT
        function l.schedule:no_context/get_queue_pos
    ##
##
