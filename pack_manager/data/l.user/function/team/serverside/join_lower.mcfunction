$execute unless entity $(lower) run return run function l.core:show_error {error_code:"JOIN_TO_OFFLINE_PLAYER"}
...
## JOIN
    $scoreboard players operation @s l.team.current = $(lower) l.team.current
##
