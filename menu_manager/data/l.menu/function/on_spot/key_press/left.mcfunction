...
execute store result score @s l.menu.stage_secondary run data get storage leinad_temp:menu next.adv_l.target_stage
data modify storage leinad_temp:menu temp.stage set from storage leinad_temp:menu next.adv_l.target_stage
    function l.menu:on_spot/key_press/macro/get_next with storage leinad_temp:menu temp
