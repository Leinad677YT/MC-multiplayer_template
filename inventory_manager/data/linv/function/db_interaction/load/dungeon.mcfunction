...
execute in overworld run data modify storage stringlib:temp data.Input set from block 0 -63 0 Items[0].components."minecraft:profile".name
...
execute in overworld run function linv:db_interaction/prepare_load with storage leinad_temp:player invcache
