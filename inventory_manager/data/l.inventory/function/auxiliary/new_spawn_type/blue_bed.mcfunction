...
data modify storage leinad_temp:player spawn.macro set value {forced:false,block:"minecraft:blue_bed"}
function l.inventory:db_interaction/update/spawn_changed
advancement revoke @s only l.inventory:changed_spawnpoint/blue_bed