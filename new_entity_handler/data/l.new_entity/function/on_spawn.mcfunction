$execute if entity @s[tag=l.new_entity.v$(version),scores={l.new_entity.aux_checks=1}] run return fail
...
execute unless entity @s[tag=l.core.has_data,scores={l.new_entity.aux_checks=1}] run function #zleinad_pack_manager:call/new_entity/on_entity_spawn
