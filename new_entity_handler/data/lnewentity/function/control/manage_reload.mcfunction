## COMPARE WITH OLD VERSION 
    ...
    execute store result score #temp lcore.temp_condition run data modify storage leinad_perm:version on_entity_spawn.data.current set from storage leinad_temp:entity_spawn macro.data
